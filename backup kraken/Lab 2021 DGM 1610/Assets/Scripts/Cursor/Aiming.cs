...
public class Aiming : MonoBehaviour
{
    ...
    // similar to the player aim script this aims at the x and y position of the reticle in space but the z position 
    // is impossible to get from a screen to world point as is why it must be declared beforehand here to funcion 
    // properly. this is a script i made myself.
